...
class VBMixture:
    ...
    def E2(self, X, r, alpha, beta, m, W):
        """
        E[log p(Z|π)]
        """
    ...
    def E4(self, X, r, beta, eta, m, W, beta_0, eta_0, m_0, W_0):
        """
        E[log p(μ, Λ)]
        """
        N, M = X.shape
    ...
    def _gmm_lower_bound(self, X, r, alpha, beta, eta, m, W, alpha_0, beta_0, eta_0, m_0, W_0):
        ...
        E2_val = self.E2(X, r, alpha, beta, m, W)
        E3_val = self.E3(X, r, alpha, alpha_0)
        E4_val = self.E4(X, r, beta, eta, m, W, beta_0, eta_0, m_0, W_0)
        E5_val = self.E5(r)
